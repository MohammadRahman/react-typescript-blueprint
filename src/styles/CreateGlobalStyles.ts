...
:root {
 ...
 --color-sidebar: #25263B;
  ...
  --color-white: #fff;
  --color-card-shadow-green:5,163,93;
  --card-shadow-black:103,106,162;
  --card-shadow-pink:249,66,128;
  --card-shadow-blue:26,93,241;
...
--image-opacity: 90%;
  ...
  /* Indigo */
  --color-brand-50: #effef6;
  --color-brand-100: #d9ffeb;
  --color-brand-200: #b6fcd7;
  --color-brand-300: #7df8b9;
  --color-brand-400: #3deb93;
  --color-brand-500: #13d474;
  --color-brand-600: #0b8a4c;
  --color-brand-700: #0b8a4c;
